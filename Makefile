...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/11/27 12:46:45 by egreen            #+#    #+#              #
#    Updated: 2017/11/27 12:51:55 by egreen           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PRINTF = printf/ft_printf.c \
		...
		printf/format_wstring.c \
		printf/helper.c \
		printf/decimal_helper.c \
		printf/hex_helper.c
...
$(NAME):
	@gcc -Wall -Wextra -Werror -c $(SRCS) -g
	@ar rc $(NAME) *.o
	@ranlib $(NAME)
